...
namespace ValueVille.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    if (!(domain.ToUpper() == "VALUEVILLE.COM" || domain.ToUpper() == "ROCKSOLVE.COM"))
        //    {
        //        isValid = false;
        //    }
        //    return isValid;
        ...
        public async Task ApplyRoles(ApplicationUser user)
        {
            // Users domain
            string domain = user.Email.Split('@')[1];
            // Any organizations with that?
            var context = Request.GetOwinContext().Get<ApplicationDbContext>();
            // Its on?
            if (string.Compare(domain.ToUpper(), "ROCKSOLVE.COM") == 0 || string.Compare(domain.ToUpper(), "VALUEVILLE.COM") == 0)
            {
